		       						...
		       						<div class="row">
		       							<div class="col-md-9 col-lg-8 col-xl-7">
		       								<div class="caption-txt text-left white-color">
												...
												<div class="box-list">							
													<div class="box-list-icon"><i class="fas fa-genderless"></i></div>
													<p class="p-md">Stay aware of the latest COVID-19 information by regularly checking updates from WHO and your national and local public health authorities.
													</p>							
												</div>								         
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-lg-12">
							<div class="txt-block pc-30 wow fadeInUp" data-wow-delay="0.4s">
								...
								<!-- Section ID -->	
					 			<span class="section-id blue-color">Protect yourself and others from COVID-19</span>
								...
								<div class="singnature mt-35">
									...
									<!-- Text -->
									<p class="p-small mb-15">Rafiqul islam, Head of Clinic</p>
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-lg-12">
							<div class="txt-block pc-30 wow fadeInUp" data-wow-delay="0.4s">
								...
								<!-- Title -->
								<h3 class="h3-md steelblue-color">How to make your environment safer</h3>
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-lg-12">
							<div class="txt-block pc-30 wow fadeInUp" data-wow-delay="0.4s">
								...
								<!-- Title -->
								<h3 class="h3-md steelblue-color">What to do to keep yourself and others safe from COVID-19</h3>
				...
				<div class="bg-scroll bg-inner bg-image division">
					<div class="container white-color">
						<div class="row d-flex align-items-center">
							...
							<div class="col-lg-5">
								<div class="banner-2-img" style="padding-top:20px; margin-top:5px">
									<img  class="img-fluid" src="img/covid-19.png" alt="banner-image" />	
								</div>
							</div>
							...
							<div class="col-lg-6 offset-lg-1">
								<div class="banner-txt pc-30 wow fadeInUp" data-wow-delay="0.4s">
									...
									<!-- Title  -->
									<h3 class="h3-lg">What to do to keep yourself and others safe from COVID-19</h3>
							...
							<div class="tab-content" id="pills-tabContent">
								...
								<div class="tab-pane fade show active" id="tab-1" role="tabpanel" aria-labelledby="tab1-list">
									<div class="row d-flex align-items-center">
										...
										<div class="col-lg-6">
											<div class="tab-img">
												<img class="img-fluid" src="img/covid.jpg" alt="tab-image" />
											</div>
										</div>
										...
										<div class="col-lg-6">
											<div class="txt-block pc-30">
												...
												<!-- Title -->
												<h3 class="h3-md steelblue-color">Don’t forget the basics of good hygiene</h3>

												<!-- Text -->
												<p class="mb-30">Regularly and thoroughly clean your hands with an alcohol-based hand rub or wash them with soap and water. This eliminates germs including viruses that may be on your hands.
...
<!-- Mirrored from jthemes.net/themes/html/medservices/files/demo-11.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Jan 2021 04:10:16 GMT -->
</html>	